...
def _add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--min-marker-vox", type=int, default=20)
    parser.add_argument("--min-support-pair", type=int, default=10)
...
def main():
    ...
    run.add_argument("--trim-q", type=float, default=1.0)
    run.add_argument("--min-vol-um3", type=float, default=0.01)
